...
public class Client {
    ...
    //FILE METHODS
    public void uploadFile(String uploadPath, ContentType contentType, byte[] body, ResultHandler<JsonNode> handler) {
        fileClientDelegate.upload(uploadPath, contentType, body, handler);
    }

    public void uploadFile(String uploadPath, File file, ResultHandler<JsonNode> handler) {
        fileClientDelegate.upload(uploadPath, file, handler);
    }

    public void downloadFile(String downloadPath, ResultHandler<InputStream> handler) {
        fileClientDelegate.download(downloadPath, handler);
    }


    public void deleteFile(String deletePath, ResultHandler<JsonNode> handler) {
        fileClientDelegate.delete(deletePath, handler);
    }
